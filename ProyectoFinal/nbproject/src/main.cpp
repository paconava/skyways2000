    ...
    while (psi) {
        ...
        switch (inputManager.getGameState()) {
            ...
            case 1:
                ...
                for (int i = 0; i < maps[inputManager.mapLoaded]->coinVector.size(); i++) {
                ...
                if (inputManager.getExploding()) {
                    ...
                    if (inputManager.getTimeExploding() < inputManager.totalExplosion) {
                        ...
                        if (remainingLives < 0) {
                            for (int i = 0; i < 4; i++)
                                for (int j = 0; j < maps[i]->coinVector.size(); j++)
                    ...
                    for (int i = 0; i < m_obsVector.size(); i++) {
                    ...
                    for (int i = 0; i < m_fallsVector.size(); i++) {
